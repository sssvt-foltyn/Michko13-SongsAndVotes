...
namespace SongsAndVotes.Server
{
    ...
    public static class ControllerContextExtensions
    {
        ...
        public static IActionResult MyDisplayRouteInfo(this ControllerContext ctx, string id = null, string msg = null)
        {
        ...
        public static string ToCtxString(this ControllerContext ctx, string id = null, string msg = null )
        {
            ...
            return $"{methods} {path} {areaStr} {ids} {ors} {tms} {controllerName}.{actionName} {routeName} {msg}";
        }
